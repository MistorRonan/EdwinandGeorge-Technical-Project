...
INPUT_DEFAULT_PROFILES = {
    ...
    keyboard_and_mouse:
    {
        ...
        confirm : [input_binding_key(vk_space),input_binding_key(vk_enter)],
    ...
    gamepad:
    {
        ...
        action:  [input_binding_gamepad_button(gp_face3),input_binding_gamepad_button(gp_start)],
        special: input_binding_gamepad_button(gp_face4),
        confirm :  input_binding_gamepad_button(gp_face1),
		attack: [input_binding_gamepad_button(gp_face2)],
